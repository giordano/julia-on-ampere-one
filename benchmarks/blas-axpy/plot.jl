...
function plot_benchmarks(title, julia, openblas, armpl; type::Union{Nothing,DataType}=nothing)
...
plot_benchmarks("axpy (single precision)", julia_32, openblas_32, armpl_32; type=Float32)
savefig("axpy-single.pdf")
plot_benchmarks("axpy (double precision)", julia_64, openblas_64, armpl_64; type=Float64)
